...
// Default dashboard stats for placeholder
const defaultStats = {
  totalLicenses: 52,
  activeLicenses: 32,
  expiredLicenses: 16,
  ...
  recentActivations: [
    {
      id: "1",
      licenseKey: "VM-A1B2-C3D4-E5F6-G7H8",
      fullName: "Jane Smith",
      deviceId: "device-123456789abcdef",
      timestamp: new Date().toISOString(),
    },
    {
      id: "2",
      licenseKey: "VM-H7G6-F5E4-D3C2-B1A0",
      fullName: "John Doe",
      deviceId: "device-987654321fedcba",
      timestamp: new Date(Date.now() - 3600000).toISOString(),
    },
    {
      id: "3",
      licenseKey: "VM-Z9Y8-X7W6-V5U4-T3S2",
      fullName: "Alice Johnson",
      deviceId: "device-abcdef123456789",
...
const generateActivityData = () => {
  ...
  for (let i = 14; i >= 0; i--) {
    ...
    // More realistic data with weekday patterns
...
export default function DashboardPage() {
  ...
  const [deviceTypeData, setDeviceTypeData] = useState(defaultDeviceTypeData);
